...
pygettext.py -o $localedir/messages.pot tcexpr.py event/listeners.py
...
echo Generating tcexpr.mo ...
msgfmt.py -o $localedir/zh_CN/LC_MESSAGES/tcexpr.mo $localedir/zh_CN.po
...
echo Generating tcexpr.mo ...
msgfmt.py -o $localedir/en_US/LC_MESSAGES/tcexpr.mo $localedir/en_US.po
